...
Sub sendOutlookEmailunNote(EmailAdd As String, colItem As String, emailOpt As String)
    ...
    FilePathToAdd = "D:\Users\admin\Documents\koala_facts\PDF Files\koala_cuddles.pdf"
    ...
    With oMail
        ...
        .HTMLBody = readTXTFile("D:\Users\admin\Documents\HTML Koala\YourKoalaHasArrived.txt")
        .Subject = "[Collection Notification] - Your Koala " & colItem & " is ready for collection"
        .To = EmailAdd
    End With
